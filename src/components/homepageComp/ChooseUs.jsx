...
const ChooseUs = () => {
  ...
  <div class="container mx-auto px-4 lg:w-10/12">
    ...
    <h2 class="text-3xl font-bold text-center text-green-600 mb-8">Why Choose Us</h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      
     
      <div class="bg-white shadow-lg rounded-lg text-center flex flex-col items-center p-6">
