    ...
    return (
        <div className="relative rounded-b-3xl overflow-hidden">
            ...
            <div className="absolute lg:w-[60%] w-[80%] top-[30%] z-10 left-[10%] lg:left-[20%]">
                <h1 className="lg:text-6xl text-5xl font-extrabold leading-tight text-center text-white z-20">Your Partner in Agro-Allied Services, Import and Export, and IT Solutions.</h1>
            </div>
        </div>
    );
};
